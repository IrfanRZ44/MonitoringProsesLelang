...
public class fragProgressDocs2 extends Fragment {
    private View view;
    private TextView textFrag;
    private String fragment;

    public fragProgressDocs2(String fragment) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_progress_docs_2, container, false);
